...
# checkpoint
  write.csv(xval[i,] , paste0("output/", Sys.Date(),".",i,".CP_DvsD_SVM(xNIC).csv"), row.names = FALSE)
  write.csv(SVM_hyPar[i,] , paste0("output/", Sys.Date(),".",i,".CP_DvsD_SVMhyPar(xNIC).csv"), row.names = FALSE)
