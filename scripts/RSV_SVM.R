...
for (i in 1:n_k){
  ...
  # checkpoint
  write.csv(xval[i,] , paste0("../results/", Sys.Date(),".",i,".RSV_SVM.csv"), row.names = FALSE)
  write.csv(SVM_hyPar[i,] , paste0("../results/", Sys.Date(),".",i,".RSV_SVMhyPar.csv"), row.names = FALSE)
