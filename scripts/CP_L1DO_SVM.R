...
# checkpoint
  write.csv(xval[i,] , paste0("../results/", Sys.Date(),".",i,".CP_DvsD_SVM.csv"), row.names = FALSE)
  write.csv(SVM_hyPar[i,] , paste0("../results/", Sys.Date(),".",i,".CP_DvsD_SVMhyPar.csv"), row.names = FALSE)
